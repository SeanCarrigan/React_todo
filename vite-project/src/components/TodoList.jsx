...
function TodoList() {
  ...
  const [isShowFeaturesVisible, setIsShowFeaturesVisible] = useToggle();
  ...
  return (
    <>
      ...
      <div className="toggles-container">
        <button onClick={setIsShowFeaturesVisible} className="button">
          {!isShowFeaturesVisible ? "Show Features" : "Hide Features"}
        </button>
      </div>
